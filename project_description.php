...
-->
 ...
 <a href="ourskill.php" class="list-group-item">Profile
  ...
  <a href="notification.php" class="list-group-item">
    <?php 
        $post_usr_id = $_SESSION['id'];
        $sql = "SELECT * FROM notification WHERE post_usr= '" . $post_usr_id . "'"; 
...
?>
            ...
            <div class="post-footer">
                <div class="input-group"> 
                    ...
                    <input class="form-control"  type="hidden" name="pid" value="<?= $p_id;?>">
                    <input class="form-control"  type="hidden" name="comme_id" value="<?= $post_usr_id;?>">
                    ...
                    while($comnt=mysqli_fetch_array($sql)){
                            ...
                            $user = mysqli_fetch_assoc(mysqli_query($con, 'SELECT * FROM registration WHERE usr_id = ' . $comnt['user_id_c']));
